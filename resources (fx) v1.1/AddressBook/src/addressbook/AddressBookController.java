...
public class AddressBookController implements Initializable {
    ...
    @FXML private ListView leftList;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        presenter = new Presenter(leftList, firstName, lastName, phone, email, address, postCode, city);
        presenter.init();
        leftList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            @Override
